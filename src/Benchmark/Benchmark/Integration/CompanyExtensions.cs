namespace Benchmark
{
	...
	{
		public static CompanyFundamentals ToCompanyFundamentals(this DataStructures.FundamentalData.Company company)
        {
        ...
        public static CompanyFundamentals ToCompanyFundamentals(this DataStructures.FundamentalData.Filing filing, string ticker, string companyName)
        {
            var fundamentals = new CompanyFundamentals();
