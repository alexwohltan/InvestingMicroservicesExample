namespace Benchmark
{
	...
	{
		public IEnumerable<MarketBenchmark> MarketBenchmarks { get; }
		public IEnumerable<SectorBenchmark> SectorBenchmarks { get; }
		public IEnumerable<IndustryBenchmark> IndustryBenchmarks { get; }
