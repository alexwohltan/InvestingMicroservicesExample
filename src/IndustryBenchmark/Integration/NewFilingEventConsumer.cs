...
namespace Benchmark
{
	public class NewFilingEventConsumer : IIntegrationEventHandler<NewFilingEvent>
	{
        private readonly IBenchmarkRepository _Repository;

        public NewFilingEventConsumer(IBenchmarkRepository repository)
		{
            _Repository = repository;
		}

        public async Task Handle(NewFilingEvent @event)
        {
